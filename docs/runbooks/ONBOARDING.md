...
- Auditoria — endpoint unificado: [docs/runbooks/auditoria-endpoint.md](./auditoria-endpoint.md)
- Storage de fotos (ABA01) — políticas/RLS e fluxo de upload: [docs/runbooks/storage-photos-aba01.md](./storage-photos-aba01.md)
- Segurança — secret scanning (gitleaks): [docs/runbooks/security-secrets-scanning.md](./security-secrets-scanning.md)
- Segurança — resposta a incidentes: [docs/runbooks/security-incident-response.md](./security-incident-response.md)
- Segurança — backups, acessos e rotação: [docs/runbooks/security-backups-access-rotation.md](./security-backups-access-rotation.md)
