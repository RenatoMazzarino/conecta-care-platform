...
| ABA02 | `docs/contracts/pacientes/ABA02_ENDERECO_LOGISTICA.md` | Em revisao | `supabase/migrations/202512201726_pacientes_aba02_integracoes_cep_geocode_risk.sql` |
| ABA03 | `docs/contracts/pacientes/ABA03_REDE_APOIO.md` | Em implementacao | `supabase/migrations/202512211507_pacientes_aba03_rede_apoio.sql` |
| ABA04 | `docs/contracts/pacientes/ABA04_ADMIN_FINANCEIRO.md` | Aprovado | `supabase/migrations/202512221400_pacientes_aba04_admin_financeiro.sql` |
