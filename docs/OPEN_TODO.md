...
6) **UI Escalas (paciente/profissional)** (P1) — DoD: telas na casca Fluent A com command bar + header contextual + abas + cards, ações de aprovação/ocorrências (mock inicial permitido).  
